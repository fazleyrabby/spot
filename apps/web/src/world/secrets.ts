...
export const WORLD_SECRETS: WorldSecret[] = [
  ...
  },
  {
    ...
    clue: 'Beside Midnight the cat in Cafe Promenade at (19, 68), a cozy cafe serves steaming espresso.',
  ...
  },
  {
    ...
    clue: 'Along the northern border at (48, 0), the grand terminal welcomes travelers arriving by high-speed rail.',
  ...
  {
    id: 'great_oak',
    name: 'The Grand Elder Oak',
    district: 'Central Park Glade',
    icon: '🌳',
    gx: 66,
    gy: 12,
    category: 'lore',
    title: 'The Grand Elder Oak',
    subtitle: 'Heart of the Central Park Glade',
    description:
      'A colossal, centuries-old elder oak with sprawling mossy roots and a sweeping emerald canopy. A glowing amber lantern sways gently from its lower branch, welcoming tired travelers to rest on the circular bench beneath its shade.',
    clue: 'In the open glade north of Central Park Lake at (66, 12), a colossal ancient oak watches over the park with a warm hanging lantern.',
    actionLabel: 'Rest in the Shade 🍃',
    reward: 'Elder Forest Keeper',
    quote: '“Deep roots never fear the storm; they hold the memory of the earth.”',
  },
  {
    id: 'master_bonsai',
    name: 'The Millennium Zen Bonsai',
    district: 'Zen Gardens Sanctuary',
    icon: '🪴',
    gx: 70,
    gy: 74,
    category: 'interactive',
    title: 'The Millennium Zen Bonsai',
    subtitle: 'Living sculpture of patience & stillness',
    description:
      'A legendary miniature juniper bonsai sculpted across generations in a carved granite basin. Its graceful driftwood trunk and stepped needle clouds radiate a calm, tranquil emerald luminescence with fluttering prayer ribbons.',
    clue: 'In the center of the quiet raked gravel courtyard in the Zen quarter at (70, 74), look for a sacred sculpted bonsai on a stone pedestal.',
    actionLabel: 'Contemplate in Silence 🌸',
